...
# 起点 (START): 用户实测 — 小车中心在 start_zone 几何中心 (1.000, 0.295),
# 朝向 = zone 左上角 (0.600, 0.600) 方向 (沿对角线朝左上)
# yaw = atan2(0.305, -0.400) ≈ 2.498 rad ≈ 143°
# zone 范围 x[0.601, 1.399] y[0, 0.595]
START_POINT = {"x": 1.000, "y": 0.295, "yaw": 2.498}
